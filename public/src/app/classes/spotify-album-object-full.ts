...
export class SpotifyAlbumObjectFull {
  constructor(
    ...
    // the most popular. The popularity is calculated from the popularity of the album’s individual tracks.
    public popularity: number,
    // The date the album was first released, for example 1981. Depending on the precision, it might
    // be shown as 1981-12 or 1981-12-15.
